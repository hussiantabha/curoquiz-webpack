...
import filmImg from "../public/assets/films.jpg";
import gadgetImg from "../public/assets/gadgets.jpg";
import sportsImg from "../public/assets/sports.jpg";
function App() {
      ...
      <section className="quiz-card-section-container">
        <div className="quiz-card-container">
          <Link to="/rules" state={{ from: "/film-quiz" }}>
            <div className="quiz-img-container">
              <img src={filmImg} className="quiz-img" alt="Suits" />
            </div>
        ...
        <div className="quiz-card-container">
          <Link to="/rules" state={{ from: "/gadget-quiz" }}>
            <div className="quiz-img-container">
              <img src={gadgetImg} className="quiz-img" alt="startups" />
            </div>
            <div className="quiz-content-container">
              <h2>Gadgets Quiz</h2>
        ...
        <div className="quiz-card-container">
          <Link to="/rules" state={{ from: "/sports-quiz" }}>
            <div className="quiz-img-container">
              <img src={sportsImg} className="quiz-img" alt="ipl" />
            </div>
            <div className="quiz-content-container">
              <h2>Sports Quiz</h2>
